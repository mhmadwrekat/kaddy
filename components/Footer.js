          ...
          <div class="flex justify-center gap-x-12 py-6">
            <a href="https://wa.me/+962788818125" data-tippy-content="WhatsApp">
              <img src='./assest/whatsapp.png'
                className='w-6 h-6 fill-current lg:w-7 lg:h-7 hover:scale-125 cursor-alias animate-pulse' />
            </a>
            <a className="pb-0.5 rounded-full hover:scale-125" href="https://www.facebook.com/Kaddy-oil-919674034765987"
              ...
              <img src='./assest/facebook.png'
                className='w-6 h-6 mt-0 lg:w-7 lg:h-7 fill-curren cursor-alias animate-pulse' />
            </a>
            <a className="rounded-full hover:scale-125" href="https://www.instagram.com/kaddy_oil/?utm_source=qr"
              ...
              <img src='./assest/instagram.png'
                className='w-6 h-6 mt-0.5 animate-pulse fill-current cursor-alias lg:w-7 lg:h-7' /></a>
          </div>
          {/* MOBILE FORM */}
          {/* MOBILE FORM */}
            ...
            <form ref={formMobile} onSubmit={handelSubscribeMobile} >
              <div class="grid md:grid-cols-3 gird-cols-1 gap-4 justify-center items-center">
                ...
                <div class="md:mr-auto mb-6">
                  <button type="submit" class="inline-block px-6 py-2 border-2 bg-blue-900 border-teal-500 text-white font-medium text-xs leading-tight uppercase rounded hover:bg-white hover:text-teal-700 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                    إرسال
                  </button>
                </div>
              </div>
